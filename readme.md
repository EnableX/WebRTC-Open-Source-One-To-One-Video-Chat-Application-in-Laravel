# 1-to-1 RTC: A Sample Web App using Laravel (PHP Framework) and EnableX Web Toolkit
...
This basic 1-to-1 Video Chat Application is developed using HTML, CSS, Bootstrap v4.0.0-alpha.6, JavaScript, jQuery, Laravel and EnxRtc (The EnableX Web Toolkit).
...
* Clone or download this Repository [https://github.com/EnableX/Sample-Laravel-Web-App-1to1-RTC.git] & follow the steps further 
